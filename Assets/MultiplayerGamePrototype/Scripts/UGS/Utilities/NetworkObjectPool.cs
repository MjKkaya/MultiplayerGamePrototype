...
namespace MultiplayerGamePrototype.UGS.Utilities
{
    ...
    class PooledPrefabInstanceHandler : INetworkPrefabInstanceHandler
    {
        ...
        {
            return m_NetworkObjectPool.GetNetworkObject(m_Prefab, position, rotation);
        }

        void INetworkPrefabInstanceHandler.Destroy(NetworkObject networkObject)
        {
            m_NetworkObjectPool.ReturnNetworkObject(networkObject, m_Prefab);
        }
    }
    ...
    public class NetworkObjectPool : SingletonNetwork<NetworkObjectPool>
    {
        ...
        {
            Debug.Log("NetworkObjectPool-OnNetworkSpawn");
        ...
        {
            Debug.Log("NetworkObjectPool-OnNetworkDespawn");
        ...
        {
            Debug.Log("NetworkObjectPool-OnValidate");
        ...
        {
            Debug.Log("NetworkObjectPool-GetNetworkObject");
        ...
        {
            Debug.Log("NetworkObjectPool-ReturnNetworkObject");
        ...
        private void RegisterPrefabInternal(GameObject prefab, int prewarmCount)
        {
            ...
            NetworkManager.PrefabHandler.AddHandler(prefab, new PooledPrefabInstanceHandler(prefab, this));
        }
    }
}